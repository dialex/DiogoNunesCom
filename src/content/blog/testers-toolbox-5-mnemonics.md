...
> Example: You finished an exploratory session and now you want to summarise your findings. Usually you describe the Past (what you explored), the Results (what you discovered), the Obstacles (what prevented better testing), the Outlooks (what should be tested next), the your Feelings (how you felt while using the product under test). That's a lot of things to remember! But if you take the first letter of every word, you get `PROOF` — that's an acronym. "After I explore, I need to bring… `PROOF`" — that's a mnemonic.
...
- **When using [Specification By Example](https://dialex.github.io/start-testing/#/notebook/specification-by-example.md) to write features: `OOPSI`** by [Jenny Martin](https://jennyjmar.com/2016/04/16/bdd-discovery-and-oopsi/)
...
- **When writing automated tests: `SACRED`** by [Richard Bradshaw](https://youtu.be/z9m_yZMswOQ?t=56)
  ...
  - Codified [oracle](https://dialex.github.io/start-testing/#/toolbox/oracles.md): conditions that will decide whether the observed behaviour was expected (e.g. assertions)
...
- **When looking for test [oracles](https://dialex.github.io/start-testing/#/toolbox/oracles.md): `FEW HICCUPPS`** adapted by [Michael Bolton](https://www.developsense.com/blog/2012/07/few-hiccupps/)
...
- **When starting an exploratory testing session: `TORCH`** by [Simon Tomes](https://docs.google.com/document/d/1rKYmujVhUlNgfeYIBot12Z8E7S0Y_Z4pk5pefK7xO3g/edit)
  ...
  - Oracles: Who or what will help you act on the information you discover? (see [oracles](https://dialex.github.io/start-testing/#/toolbox/oracles.md))
  - Risks: What do you want to learn about? (see [charters](https://dialex.github.io/start-testing/#/toolbox/charters.md))
  - Consider: What questions do you want to answer? (see **`WWWWWHEK`** mnemonic)
  - Heuristics: What triggers will guide your session? (see [heuristics](https://dialex.github.io/start-testing/#/toolbox/heuristics.md))
...
- **When assessing your product's [testability](https://dialex.github.io/start-testing/#/concepts/testability.md): `SOCKS`** by [Adam Knight](https://www.a-sisyphean-task.com/2012/07/putting-your-testability-socks-on.html)
  ...
  - Knowledge: you should have access to information (and [oracles](https://dialex.github.io/start-testing/#/toolbox/oracles.md)) about the product under test
  - Stability: you should have a stable environment and product to perform your testing
- **When looking for ways to improve your product's [testability](https://dialex.github.io/start-testing/#/concepts/testability.md): `VIPS`** by [James Bach](https://www.satisfice.com/download/heuristics-of-software-testability)
...
- **When designing a test strategy for a new project: `SADDEST PPIRATEE`** by [Diogo Nunes](/blog/test-strategy-saddest-ppiratee-mnemonic/) (adapted from **[`GRATEDD SCRIPTS`](http://www.software-testing.com.au/blog/2009/07/21/thinking-about-test-strategy-a-mnemonic-device/)**)
  - Scope
  - Approach
  - Dependencies
  - Data
