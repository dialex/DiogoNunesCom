...
Persons are bought and managed like [CPUs](http://en.wikipedia.org/wiki/Central_processing_unit). The Human Resources of companies buy all the best and most hardworking new graduates they can find. The Human Resources (HR) department is only interested in these kind of persons because they're **top performers, full of energy, and with no (family) responsibilities**.

Once the HR has acquired these new "CPUs" they start to shape them to fit the existing [motherboard](http://en.wikipedia.org/wiki/Motherboard)'s (company's) [chipset](http://en.wikipedia.org/wiki/Chipset) (way of doing things). That is, the HR infuse the newcomers with the company's culture and - worst than that - the HR ensures that all newcomers **dress the same, think the same, and act the same**. It's all about consistency. So that's how they handle "diversity", they ask you to leave your personality at home.
