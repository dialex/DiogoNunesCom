...
$ccount_settings['admin_pass']='http://www.diogonunes.com/assets/downloadmanager';

// URL of the click.php file
$ccount_settings['click_url']='http://www.diogonunes.com/assets/downloadmanager/click.php';
