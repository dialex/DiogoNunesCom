...
Knowing your oracles means that you can **objectively explain** to developers and business stakeholders why the users of the software will agree that you have found a bug. This makes your [bug advocation](https://dialex.github.io/start-testing/#/roles/bug-hunter.md) more effective.
