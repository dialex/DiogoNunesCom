...
[James Bach](https://www.satisfice.com/download/heuristic-test-strategy-model)'s Heuristic Test Strategy Model (HTSM) contains more tips on how to explore your product ([**`SFDIPOT`**](https://dialex.github.io/start-testing/#/toolbox/mnemonics?id=⛺%ef%b8%8f-exploration)) and its non-functional properties ([**`CRUCSPIC STMP`**](https://dialex.github.io/start-testing/#/toolbox/mnemonics?id=%f0%9f%92%a1-product)).

This presentation from [Karen Johnson](http://karennicolejohnson.com/wp-content/uploads/2012/11/KNJohnson-2012-heuristics-mnemonics.pdf) demonstrates how you can use heuristics like [**`RCRCRC`**](https://dialex.github.io/start-testing/#/toolbox/mnemonics?id=-automation) (ideas about what to check on regression testing) or [**`FEW HICCUPPS`**](https://dialex.github.io/start-testing/#/toolbox/mnemonics?id=⛺%ef%b8%8f-exploration) (oracles focused on consistency) in practice. To discover other mnemonics, check this [cheat sheet](https://dialex.github.io/start-testing/#/toolbox/mnemonics).
