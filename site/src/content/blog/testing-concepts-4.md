...
Your responsibility as a tester is to fulfil the [purpose of testing](https://dialex.github.io/start-testing/#/concepts/testing-purpose.md).
...
A good tester should be meticulous, curious, creative, determined and mindful of biases. A greater tester, nurtures the [student mindset](https://dialex.github.io/start-testing/#/next/index.md) and is humble enough to be always learning.
