...
description: "%%excerpt%% Testing’s purpose is to measure and maximise quality delivered, while minimising risk to an acceptable level"
...
You just read 43 words in a single sentence. [Hemingway](http://www.hemingwayapp.com/) hates it and your brain hates it too. Instead, let's focus on what is the purpose of testing — why we need it and what it is. From there, we can think about the [responsibilities of a tester](https://dialex.github.io/start-testing/#/concepts/tester-responsibilities.md).
...
For specific examples, continue reading [what testing is](https://dialex.github.io/start-testing/#/concepts/what-testing-is.md) and [what testing is not](/concepts/what-testing-is-not.md).
